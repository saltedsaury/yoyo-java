...
public class MonitorLogUtils {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("tokenShip-Monitor-info");
    private static final Logger LOGGER_ERROR = LoggerFactory.getLogger("tokenShip-Monitor-error");


    public static final String MODULE = "tokenShip";
